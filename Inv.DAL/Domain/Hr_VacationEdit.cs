...
namespace Inv.DAL.Domain
{
    ...
    public partial class Hr_VacationEdit
    {
        public int VacationEditDocId { get; set; }
        public Nullable<int> VacationDocId { get; set; }
        ...
        public Nullable<System.DateTime> NewReturnDate { get; set; }
        public Nullable<int> DayCount { get; set; }
        public Nullable<int> NewDayCount { get; set; }
        public Nullable<int> NetDaysCount { get; set; }
        public Nullable<int> NewNetDaysCount { get; set; }
