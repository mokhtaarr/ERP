...
namespace Inv.DAL.Domain
{
    ...
    public partial class Proj_ReserveUnitOwners
    {
        ...
        public Nullable<int> UnitConcessionId { get; set; }
        public Nullable<System.DateTime> ConcessionDate { get; set; }
        public string ConcessionDocNo { get; set; }
        public Nullable<int> OriginalResourceId { get; set; }
        public Nullable<byte> OriginalResourceType { get; set; }
        public Nullable<int> OriginalResourceAccountId { get; set; }
