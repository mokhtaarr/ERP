...
var currentTime = new Date();
    ...
    var currentTimeString = currentHoursAP + ":" + currentMinutes + ":" + currentSeconds ;
       
      $("#time").text(currentTimeString+""+timeOfDay);
...
var da=new Date();
$("#date").text(da.getDate()+"/"+(da.getMonth()+1)+"/"+da.getFullYear());
})