;(function ( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function () {
        ...
        if($('#slidepanel').length == 0){
            var panel_html = '<div id="slidepanel" class="cb_slide_panel"><div class="wrapper"><a href="#" class="close"></a><div class="inner"><div class="wrapper"></div></div></div></div>';
        ...
        //bind dblclick event to trigger ajax load of html content
...
//		.......................add from me...................
		$(".aside_icon").on('click', function(e) {
            e.preventDefault();
	...
	//		.......................end add from me...................
        ...
        //listen for a dblclick on the close buttons for this panel
