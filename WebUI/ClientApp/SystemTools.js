var _moduleCode;
var _SearchControlName;
var _Condition;
var _OnSearchSelected;
var _SystemCode;
var _SubSystemCode;
var _ScreenLanguage;
var _Url;
var _GetResulte;
var _GetNameAndValue;
var arr = new Array();
...
(function (_SystemTools) {
    ...
    _SystemTools.InitalizeComponent = InitalizeComponent;
})(_SystemTools || (_SystemTools = {}));
var SystemTools = /** @class */ (function () {
    ...
    SystemTools.prototype.GetColumns = function (code) {
        var _this = this;
        Ajax.CallAsync({
    ...
    SystemTools.prototype.Searsh = function (DynamicInputs) {
    ...
    SystemTools.prototype.FindKey = function (moduleCode, SearchControlName, Condition, OnSearchSelected) {
    ...
    SystemTools.prototype.resetSearch = function () {
    ...
    SystemTools.prototype.GetNameAndValue = function () {
    ...
    SystemTools.prototype.GetResulte = function () {
        _GetNameAndValue();
        if (arr.length != 0) {
    ...
    SystemTools.prototype.JsTree = function (data) {
        $('#Tree').jstree({
            'core': {
                'data': data,
            },
...
var ListValue = /** @class */ (function () {
    ...
    ListValue.GetLetOfGrnteeTranDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetJobOrderEquipDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetJobOrderEmpDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "TotalCost", text: "إجمالى تكلفه" });
        }
    ...
    ListValue.GetUnitReservationDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetBankNoticeDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetPettyCashDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetItemStockAdjustDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetJournalEntryDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetKeeperbankDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetStockTranReqValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetStockTranValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "TotalValue", text: "اجمالى متوسط التكلفه" });
        }
    ...
    ListValue.GetSalesDeliverValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetPurchReceitValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetPurchValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetJobOrderDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetPurchOrderDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "InvTotal", text: "اجمالى الاصناف" });
            ValueArr.push({ value: "TaxValu", text: "الضرائب" });
    ...
    ListValue.GetSalesOfferDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "InvTotal", text: "اجمالى الاصناف" });
            ValueArr.push({ value: "TaxValu", text: "الضرائب" });
    ...
    ListValue.GetSalesOrderDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "InvTotal", text: "اجمالى الاصناف" });
            ValueArr.push({ value: "TaxValu", text: "الضرائب" });
    ...
    ListValue.GetSalesValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "InvTotal", text: "اجمالى الاصناف" });
    ...
    ListValue.GetRetPurchValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetRetSalesValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "RetTotal", text: "اجمالى الاصناف" });
            ValueArr.push({ value: "TaxValu", text: "الضرائب" });
    ...
    ListValue.GetAdjustValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetRecietValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetPayValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
    ...
    ListValue.GetVehicleMovValuesDataTable = function () {
        ValueArr = [];
        if (language == "ar") {
            ValueArr.push({ value: "TotalValue", text: "الاجمالى" });
            //ValueArr.push({ value:"TotalLastCost",text: "اجمالى اخر تكلفه"});
