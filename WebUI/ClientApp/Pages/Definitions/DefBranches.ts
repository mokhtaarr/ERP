...
namespace MSDefBranches {
    ...
    var txt_StoreCode: HTMLInputElement;
    var chkeck_StoreType: HTMLInputElement;
    var txt_StoreDescA: HTMLInputElement;
    var txt_BoxId: HTMLInputElement;
    var txt_StoreKeeper: HTMLInputElement;
    var txt_StorePosition: HTMLInputElement;
    var txt_Tel: HTMLInputElement;
    var BranchesList: Array<MS_Stores> = new Array<MS_Stores>();
    var BrancheDetails: MS_Stores = new MS_Stores();
    var PartitionList: Array<MS_Partition> = new Array<MS_Partition>();

    var DetBranchObj = new Array<MS_Stores>();
    var MasterDetailsBranches: MasterDetails_Branches = new MasterDetails_Branches();
    var NewMasterDetailsBranches: MasterDetails_Branches = new MasterDetails_Branches();
    var id_ul = 'menu-group-1';
    var NewPartion: MS_Partition = new MS_Partition();
    var divPartitionGrid: JsGrid = new JsGrid();
    const GridInputClassName = "form-control gridIput";
    var flagStatus = null;
    var currentStoreId = 0;
    var deletedDetails: Array<MS_Partition> = new Array<MS_Partition>();
    var ddlBoxBank: HTMLSelectElement;
    var Data = new Array();
    ...
    export function InitalizeComponent() {
        ...
        SharedButtons.AddAction(() => {
            ...
            deletedDetails = new Array<MS_Partition>();
        });
        ...
        Ajax.Callsync({
           ...
           // data: {TableName: 'MS_Stores' },
            success: (d) => {
                ...
                if (res.IsSuccess) {
                    let boxes = res.Response as Array<MS_BoxBank>;
    ...
    function InitalizeControls() {
        ...
        txt_StoreCode = document.getElementById("txt_StoreCode") as HTMLInputElement;
        chkeck_StoreType = document.getElementById("chkeck_StoreType") as HTMLInputElement;
        txt_StoreDescA = document.getElementById("txt_StoreDescA") as HTMLInputElement;
        txt_BoxId = document.getElementById("txt_BoxId") as HTMLInputElement;
        txt_StoreKeeper = document.getElementById("txt_StoreKeeper") as HTMLInputElement;
        txt_StorePosition = document.getElementById("txt_StorePosition") as HTMLInputElement;
        txt_Tel = document.getElementById("txt_Tel") as HTMLInputElement;
        SharedButtons.btnSearch = document.getElementById("btnbranchSearch") as HTMLButtonElement;

        ddlBoxBank = document.getElementById("ddlBoxBank")as HTMLSelectElement;;
    }
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                if (result.IsSuccess) {
                    ...
                    BranchesList = result.Response as Array<MS_Stores>;
    ...
    function GetMasterAndDetails(StoreId: string) {
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                let result = d as BaseResponse;
                if (result.IsSuccess) {
                    MasterDetailsBranches = result.Response as MasterDetails_Branches;
    ...
    function AddItemInGrid() {
        ...
        if ($('#hd_PartCode').val().trim() == "") { alert("يرجى ادخال البيانات اولا"); return; }
        else NewPartion.PartCode = $('#hd_PartCode').val().trim();
        if ($('#hd_PartDescA').val().trim() == "") {alert("يرجى ادخال البيانات اولا"); return; }
        else NewPartion.PartDescA = $('#hd_PartDescA').val().trim();
        ...
        else NewPartion.StatusFlag = "i";
        if ($('#hd_StorePartId').val().trim() == "") NewPartion.StorePartId = 0; else NewPartion.StorePartId = $('#hd_StorePartId').val().trim();
        ...
        divPartitionGrid.Columns = [
            {
                ...
                itemTemplate: (s: string, item: MS_Partition): HTMLButtonElement => {
                    let btn: HTMLButtonElement = DocumentActions.CreateElement<HTMLButtonElement>("button");
            ...
            ,
            {
                ...
                itemTemplate: (s: string, item: MS_Partition): HTMLButtonElement => {
                    ...
                    btn.onclick = (e) => {
                        ...
                        if (item.PartCode != null) FillInputText("hd_PartCode", item.PartCode.toString());
                       
                        if (item.PartDescA != null) FillInputText("hd_PartDescA", item.PartDescA.toString());
                        
                        if (item.StoreKeeper != null) FillInputText("hd_StoreKeeper", item.StoreKeeper.toString());
                        
                        if (item.Tel != null) FillInputText("hd_Tel", item.Tel.toString());
                       
                        if (item.Fax != null) FillInputText("hd_Fax", item.Fax.toString());
                       
                        if (item.Address != null) FillInputText("hd_Address", item.Address.toString());
                       
                        FillInputText("hd_Flag", "u");
                        if (item.StorePartId != null) FillInputText("hd_StorePartId", item.StorePartId.toString());
            ...
            , {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "PartCode", " ");
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "PartDescA", " ");
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "StoreKeeper", " ");
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "Tel", " ");
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "Fax", " ");
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("text", GridInputClassName, " ", " ", "StorePartId", " ");
                    txt.hidden = true;
    ...
    function clear() {
      //  ddlBoxBank.value = '';
        ...
        var ClearList = new Array<MS_Partition>();
        divPartitionGrid.DataSource = ClearList;
        divPartitionGrid.Bind();
        currentStoreId = 0;
        PartitionList = new Array<MS_Partition>();
    }
    ...
    function Update() {
        ...
        for (let x = 0; x < deletedDetails.length; x++) {
