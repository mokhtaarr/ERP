...
(function (MSPaymentNote) {
    ...
    var Model = new MS_PaymentNote();
    var AllPaymentNoteIds = new Array();
    ...
    var Banks = new Array();
    var Details = new PaymentNoteAndDetails();
    //select Options
    var element, TrNo, TotalItems, Rate, ValueBeforeRate, PaidPrice, BookId, TermId, RectSourceType, TranType, EmpId, BoxId, CurrencyId, CustomerId, VendorId, ClientAccNo, BankNoticId, BankAccNumber, checkfield, SelectMode_RectSourceType = [], Total = 0, TotalCurancy = 0, ObjectId = 0, StatusFlag, Success, flag = true, CuranciesGridId = new JsGrid();
    ...
    MSPaymentNote.InitalizeComponent = InitalizeComponent;
    function InitalizeControls() {
        SharedButtons.btnSearch = document.getElementById("btnMS_PaymentNoteSearch");
        TermId = document.getElementById("TermId");
        BookId = document.getElementById("BookId");
        TrNo = document.getElementById("TrNo");
        ...
        ValueBeforeRate = document.getElementById("ValueBeforeRate");
    ...
    function GetAll() {
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                var result = d;
                if (result.IsSuccess) {
                    AllPaymentNoteIds = result.Response;
                }
            }
        });
    }
    ...
    function Assign() {
        Details.PaymentNote = DocumentActions.AssignToModel(Model);
    ...
    MSPaymentNote.Navigate = Navigate;
    ...
    function checkfieldd(clear) {
        DocumentActions.allElements(false, clear, checkfield);
    }
    function GetModel(id) {
        Model = AllPaymentNoteIds.filter(function (x) { return x.PayId == id; })[0];
        return Model;
    }
    ...
    function btnSearch_onclick() {
        var sys = new SystemTools();
        sys.FindKey(Modules.MS_PaymentNote, SharedButtons.btnSearch.id, "", function () {
...
})(MSPaymentNote || (MSPaymentNote = {}));
//# sourceMappingURL=MS_PaymentNote.js.map