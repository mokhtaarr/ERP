...
namespace MsReceiptNote {
    ...
    var Model: Ms_ReceiptNote = new Ms_ReceiptNote();
    var AllReceiptNoteIds: Array<Ms_ReceiptNote> = new Array<Ms_ReceiptNote>();
    var ReceiptNoteCurrencies: Array<Ms_ReceiptNoteCurrencies> = new Array<Ms_ReceiptNoteCurrencies>();
    var CurrencyCategories: Array<CurrencyCategoryShared> = new Array<CurrencyCategoryShared>();
    var Details: ReceiptNoteAndDetails = new ReceiptNoteAndDetails();
    ...
    var element: HTMLInputElement,
        ...
        ClientBankId: HTMLSelectElement,
    ...
    function InitalizeControls() {
        SharedButtons.btnSearch = document.getElementById("btnMs_ReceiptNoteSearch") as HTMLButtonElement;
        ...
        ClientBankId = document.getElementById("ClientBankId") as HTMLSelectElement;
        ClientAccNo = document.getElementById("ClientAccNo") as HTMLSelectElement;
    ...
    function GetAll() {
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                if (result.IsSuccess) {
                    AllReceiptNoteIds = result.Response as Array<Ms_ReceiptNote>;
                }
            }
        });
    }
    ...
    function GetByID(Id: number) {
        Ajax.Callsync({
            ...
            success: (d) => {
                let result = d as BaseResponse;
                if (result.IsSuccess) {
                    let res = result.Response as Ms_ReceiptNote;
                    if (res != null) {
    ...
    function Assign() {
        Details.Ms_Receipt = DocumentActions.AssignToModel<Ms_ReceiptNote>(Model);
    ...
    function Insert(): boolean {
        ...
        Ajax.Callsync({
            ...
            success: (Response) => {
                ...
                if (result.IsSuccess) {
                    Model = result.Response as Ms_ReceiptNote;
                    ObjectId = Model.RectId;
                    Success = true;
                }
                else {
    ...
    function Display(model: Ms_ReceiptNote) {
        Model = model;
        Model.ChequeOpenId = Model.ChequeOpenId ? 1 : 0;
        Model.CheckType = Model.CheckType ? 1 : 0;
    ...
    function GetModel(id: number) {
        Model = AllReceiptNoteIds.filter(x => x.RectId == id)[0];
        return Model;
    }
    ...
    function btnSearch_onclick() {
        ...
        sys.FindKey(Modules.Ms_ReceiptNote, SharedButtons.btnSearch.id, "", () => {
