...
(function (SysBooks) {
    ...
    var AllTaxeIds = new Array();
    var Model = new Sys_Books();
    var Counter = new Sys_Counter();
    //select Options
    var element;
    var TermType;
    var ObjectId = 0;
    ...
    SysBooks.InitalizeComponent = InitalizeComponent;
    function InitalizeControls() {
        SharedButtons.btnSearch = document.getElementById("btnSys_BooksSearch");
    ...
    function InitializeGrid() {
        ...
        divBooksGrid.OnRowSelected = function () {
            Display(divBooksGrid.SelectedItem);
            SharedWork.SwitchModes(ScreenModes.Query);
        };
        divBooksGrid.OnRowDoubleClicked = function () {
            Display(divBooksGrid.SelectedItem);
            SharedWork.SwitchModes(ScreenModes.Query);
        };
    ...
    function btnSearch_onclick() {
        var sys = new SystemTools();
        sys.FindKey(Modules.Sys_Books, SharedButtons.btnSearch.id, "", function () {
...
//# sourceMappingURL=Sys_Books.js.map