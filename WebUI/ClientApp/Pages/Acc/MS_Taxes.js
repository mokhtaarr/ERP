...
(function (MSTaxes) {
    ...
    MSTaxes.InitalizeComponent = InitalizeComponent;
    function InitalizeControls() {
        SharedButtons.btnSearch = document.getElementById("btnMS_TaxesSearch");
    }
    ...
    function GetModel(id) {
        Model = AllTaxeIds.filter(function (x) { return x.TaxesId == id; })[0];
        return Model;
    }
    function btnSearch_onclick() {
        var sys = new SystemTools();
        sys.FindKey(Modules.MS_Taxes, SharedButtons.btnSearch.id, "", function () {
...
//# sourceMappingURL=MS_Taxes.js.map